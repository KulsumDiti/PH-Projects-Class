...
// OR  Tamplate - String / (Backtik)use kore:
...
//Different type of Parametar:
//****Defult Parameters Set:****//
...
function matchFinder(string1, string2) {
  if (typeof string1 !== "string" || typeof string2 !== "string") {
    return "Please provide valid strings as input";
  }
...
console.log(matchFinder(123, "ohn"));
